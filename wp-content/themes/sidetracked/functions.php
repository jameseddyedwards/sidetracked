 ...
 * @author Ade Walker http://www.studiograsshopper.ch
 */
function sidetracked_image_sizes($sizes) {
...
add_filter('intermediate_image_sizes_advanced', 'sidetracked_image_sizes');
...
*/
function sidetracked_get_image($size = 'thumbnail') {
